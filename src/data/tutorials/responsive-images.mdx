...
updates:
  - date: 2026-06-02T14:00:00+01:00
    note: 'Didaktik geschärft: Einstieg gestrafft, Strukturteil klarer für Einsteiger formuliert.'
  - date: 2026-06-02T14:00:00+01:00
    note: 'Codebeispiele überarbeitet: Attribute (`srcset`, `media`, `sizes`, `type`) gezielt hervorgehoben und `sizes` praxisnah eingeordnet.'
...
```html {1} ins={2}
<!-- Abschnitt D-->
<img src="image-400x170.jpg" width="400" height="170" alt="Mann öffnet seinen Grill, Dampf steigt auf.">
```
