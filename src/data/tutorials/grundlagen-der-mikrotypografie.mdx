...
Auf den heutigen Tastaturen, dessen Ursprung der Schreibmaschinensatz[^4] ist, gibt es für öffnende und schließende Anführungszeichen nur ein Zeichen (`"`), das zugleich als Ersatzzeichen für Zoll oder Sekunden verwendet wird.
...
Das geschütze Leerzeichen[^5] wird als Unicode oder als HTML-Code eingefügt, hier in der normalen und schmalen Variante:
