...
isDraft: false
pubDate: 2026-05-12T16:00:00+00:00
...
In größeren Projekten nennt man solche zentralen Werte oft **Design-Tokens**: einheitliche Namen für Farben, Abstände, Größen oder Schattierungen, die überall im System gleich genutzt werden.
...
Im Alltag geht es oft genau darum: Du hast eine Grundfarbe, willst aber sofort eine passende hellere oder dunklere Variante dazu. Genau das kannst du mit `color-mix()` berechnen lassen. Schau dir dazu direkt den Code an:
...
Auch Layout-Werte wie `flex-direction` oder `gap` kannst du in Variablen ablegen: Bei kleinen Bildschirmen stehen die Elemente untereinander, bei größeren nebeneinander.
