...
Wähle bei Fontsource die Schriftart aus, die du nutzen möchtest, zum Beispiel die [Gupter](https://fontsource.org/fonts/gupter), klicke dann oben rechts auf den Link „Install". Wähle bei „Installation" dann „pnpm" und installiere dann das Paket wie dort angegeben über das Terminal:

<Figure caption="Dieser Befehl installiert die Schriftart Gupter.">
```bash
pnpm add @fontsource/gupter
```
</Figure>
