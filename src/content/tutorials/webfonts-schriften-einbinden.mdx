...
cover:
  path: '/src/images/tutorials/gupter-google-fonts.png'
  alt: 'Screenshot von Google Fonts, zeigt die Schriftart Gupter.'
  caption: 'Die Schriftart Gupter ist kostenlos bei Google Fonts erhältlich.'
