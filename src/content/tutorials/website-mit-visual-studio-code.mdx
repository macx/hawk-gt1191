...
<Figure imagePath="/src/images/tutorials/vscode-new-window.png" caption="XXX" alt="XXX" />
...
<Figure imagePath="/src/images/tutorials/website-in-vscode.png" caption="Das Grundgerüst einer HTML-Datei" alt="XXXX" />
