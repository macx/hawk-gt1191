...
Damit du den Inhalten und Tutorials des Seminars GT 1191 folgen kannst, benötigst du einige Plugins und Konfigurationen. Diese müsstest du normalerweise händisch installieren und einrichten. Dank der Profile von VS Code kannst du das aber mit einem Klick erledigen. Denn in diesen sind alle Informationen zur Konfiguration enthalten.

Für das Seminar GT 1191 habe ich ein Profil erstellt, das alle notwendigen Plugins und Konfigurationen enthält, die wir nutzen.
...
> **Tipp:** Wenn du dich mit HTML und CSS noch nicht auskennst, empfehle ich dir, das Tutorial [Einstieg in HTML](/tutorials/einstieg-in-html/) zu lesen. Ein Tutorial für CSS ist in Planung.
