...
description: 'Du lernst die Grundlagen von HTML, CSS und JavaScript, sowie Techniken zur Bild- und Ladezeitoptimierung und erzielst ein optimales UI/UX-Erlebnis.'
navTitle: 'Grundlagen'
visible: true
sort: 1
toc: false
