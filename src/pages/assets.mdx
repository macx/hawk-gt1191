...
[OpenHolidays API](https://www.openholidaysapi.org/de/) <span class="new">NEU</span>
: API zur Abfrage von Feiertagen und Schulferienn (weltweit)

[Ferien API](https://ferien-api.de/) <span class="new">NEU</span>
...
[Web3Forms](https://web3forms.com/) <span class="new">NEU</span>
